...
namespace WebSite.CoockieExtension
{
    public static class SameSiteServiceCollectionExtension
    {
        public static IServiceCollection ConfigureSameSiteNoneCoockies(this IServiceCollection services)
        {
